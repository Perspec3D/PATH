            ...
            <div className="flex items-center space-x-2 ml-4">
              {(currentPage === 'projects' || currentPage === 'clients') && (
                <button
                  ...
                  className="p-1.5 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 rounded-lg transition border border-slate-200 dark:border-slate-700 flex items-center space-x-2 group active:scale-[0.98] shadow-sm"
