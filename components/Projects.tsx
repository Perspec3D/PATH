        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-md z-[100] flex items-center justify-center p-4 animate-in fade-in duration-300">
          <div className="bg-white dark:bg-[#0f172a] rounded-[40px] shadow-2xl w-full max-w-2xl h-[90vh] flex flex-col overflow-hidden border border-slate-200 dark:border-white/5 transition-all duration-500">
            <div className="px-8 py-6 bg-slate-50 dark:bg-slate-900/50 border-b border-slate-100 dark:border-white/5 flex items-center justify-between transition-colors">
              <h3 className="text-lg font-black text-slate-900 dark:text-white uppercase tracking-tight transition-colors">{editingProject ? 'Editar Detalhes' : 'Novo Projeto'}</h3>
            ...
            <form onSubmit={handleSave} className="flex-1 overflow-y-auto custom-scrollbar p-8 space-y-8 dark:bg-[#0f172a] transition-colors">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-2">
                ...
                <div className="bg-slate-50 dark:bg-slate-900/50 p-4 rounded-2xl border border-slate-100 dark:border-slate-700/50 transition-colors">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700/50 rounded-lg text-sm text-slate-900 dark:text-white focus:ring-1 focus:ring-indigo-500 outline-none font-mono transition-colors"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-5">
                  <div>
                    ...
                    <select required value={clientId} disabled={!!editingProject} className="w-full px-4 py-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl text-sm text-slate-900 dark:text-slate-100 focus:ring-2 focus:ring-indigo-500 outline-none font-medium transition-colors" onChange={(e) => setClientId(e.target.value)}>
                  ...
                  <div>
                    ...
                    <select required value={assigneeId} className="w-full px-4 py-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl text-sm text-slate-900 dark:text-slate-100 focus:ring-2 focus:ring-indigo-500 outline-none font-medium transition-colors" onChange={(e) => setAssigneeId(e.target.value)}>
                        ...
                        <div className="flex flex-col space-y-4">
                          <div className="flex items-center space-x-3">
                            <input
                              ...
                              className="flex-1 bg-transparent border-none text-sm font-bold text-slate-900 dark:text-slate-100 placeholder:text-slate-300 dark:placeholder:text-slate-700 focus:ring-0 p-0 transition-colors"
                            />
                            <button
                              type="button"
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 items-end">
                            <div className="col-span-1 md:col-span-1">
                              ...
                              <select
                                ...
                                className="w-full bg-white dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/50 rounded-lg py-1.5 px-2 text-[10px] text-slate-900 dark:text-slate-300 font-bold outline-none focus:ring-1 focus:ring-indigo-500/50 transition-colors"
                              >
                            ...
                            <div className="col-span-1 md:col-span-1">
                              ...
                              <select
                                ...
                                className={`w-full bg-white dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/50 rounded-lg py-1.5 px-2 text-[10px] font-black uppercase tracking-tighter outline-none focus:ring-1 focus:ring-indigo-500/50 transition-colors ${getStatusColor(st.status).split(' ')[1]}`}
                              >
                                {Object.values(ProjectStatus).map(s => <option key={s} value={s}>{s}</option>)}
                              </select>
                            </div>
                            ...
                            <div className="col-span-1 md:col-span-1">
                              ...
                              <input
                                ...
                                className="w-full bg-white dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/50 rounded-lg py-1.5 px-2 text-[10px] text-slate-900 dark:text-slate-300 font-medium outline-none transition-colors"
                              />
                            </div>
                          ...
                          <input
                            ...
                            className="w-full bg-white dark:bg-slate-800/30 border border-slate-100 dark:border-white/5 rounded-xl py-2 px-3 text-[10px] text-slate-500 dark:text-indigo-300/60 placeholder:text-slate-300 dark:placeholder:text-indigo-300/20 outline-none transition-colors"
                          />
                        </div>
                      </div>
                    ))
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl text-sm text-slate-900 dark:text-slate-100 focus:ring-2 focus:ring-indigo-500 outline-none font-medium min-h-[100px] resize-none transition-colors"
