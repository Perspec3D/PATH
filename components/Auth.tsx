          ...
          <div>
            ...
            <div className="relative group/pass">
              <input
                ...
                className="w-full px-5 py-3.5 bg-slate-900 border border-slate-700 rounded-2xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition text-white text-sm pr-12"
                placeholder="••••••••"
              />
              <button
                type="button"
